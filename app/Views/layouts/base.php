...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>css/layouts/spgsinfo.css?<?php echo date("YmdHis"); ?>">
 	<link rel="stylesheet" href="<?=base_url()?>css/layouts/spgsinfo-color.css?<?php echo date("YmdHis"); ?>">
